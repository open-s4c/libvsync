...
main(void)
{
    vatomic32_await_le(&g_u32_a, g_u32_v);
    vatomic32_await_le_acq(&g_u32_a, g_u32_v);
    vatomic32_await_le_rlx(&g_u32_a, g_u32_v);
    vatomic64_await_le(&g_u64_a, g_u64_v);
    vatomic64_await_le_acq(&g_u64_a, g_u64_v);
    vatomic64_await_le_rlx(&g_u64_a, g_u64_v);
}

...
main(void)
{
    vatomic32_await_lt(&g_u32_a, g_u32_v);
    vatomic32_await_lt_acq(&g_u32_a, g_u32_v);
    vatomic32_await_lt_rlx(&g_u32_a, g_u32_v);
    vatomic64_await_lt(&g_u64_a, g_u64_v);
    vatomic64_await_lt_acq(&g_u64_a, g_u64_v);
    vatomic64_await_lt_rlx(&g_u64_a, g_u64_v);
}

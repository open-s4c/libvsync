...
main(void)
{
    vatomic32_await_gt(&g_u32_a, g_u32_v);
    vatomic32_await_gt_acq(&g_u32_a, g_u32_v);
    vatomic32_await_gt_rlx(&g_u32_a, g_u32_v);
    vatomic64_await_gt(&g_u64_a, g_u64_v);
    vatomic64_await_gt_acq(&g_u64_a, g_u64_v);
    vatomic64_await_gt_rlx(&g_u64_a, g_u64_v);
}

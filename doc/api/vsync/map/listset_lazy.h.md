#  [vsync](../README.md) / [map](README.md) / listset_lazy.h
_This is a partially parallel implementation with lock-free get._ 

**Groups:** [Linearizable](../GROUP_linearizable.md), [SMR-required](../GROUP_requires_smr.md)

`vlistset_get` method is lock-free, while `vlistset_add` and `vlistset_remove` are serialized.
...
Maurice Herlihy, Nir Shavit - [The Art of Multiprocessor Programming 9.7](https://dl.acm.org/doi/pdf/10.5555/2385452) 
...
|---|---|
| [vlistset_init](listset_lazy.h.md#function-vlistset_init) | Initializes the given vlistset_t object `lst`.  |
| [vlistset_destroy](listset_lazy.h.md#function-vlistset_destroy) | Destroys all the remaining nodes in the listset.  |
| [vlistset_add](listset_lazy.h.md#function-vlistset_add) | Inserts the given node into the listset.  |
| [vlistset_remove](listset_lazy.h.md#function-vlistset_remove) | Removes the node associated with the given key from the listset.  |
| [vlistset_get](listset_lazy.h.md#function-vlistset_get) | Looks for the listset node associated with the given key.  |

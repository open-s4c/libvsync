 ...
 * @brief This implementation of listset uses fine grained locking.
 *
 * Uses one lock per node to serialize all operations.
 *
 * @example
 * @include eg_listset_fine.c
 *
 ...
 * @cite
 * Maurice Herlihy, Nir Shavit - [The Art of Multiprocessor Programming 9.5]
